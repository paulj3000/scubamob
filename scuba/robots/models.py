"""
skm/robots/models.py

(C) Copyright 2015-2020, Pjs Midnight Labs.  All rights reserved.

Author: Pauljames "The Juggernaut" Dimitriu

The database model represntations of the robots page
"""
...
class Url(UUIDModel):
    ...
    def __str__(self):
        """ define a human readable string return """
        return self.pattern

    def save(self, *args, **kwargs):
        """ override the model save.

        In this case, make sure the url starts w/ a '/'
        """
