...
urlpatterns = [
    ...
    re_path(r'edit/(?P<equipment_id>[0-9A-Fa-f-]{32,36})/?$',
            views.edit,
            name='equipment_edit_id'),
    path(r'edit/',
         views.edit,
         name="equipment_edit"),
    re_path(r'delete/(?P<equipment_id>[0-9A-Fa-f-]{32,36})/?$',
    ...
    re_path(r'^(?P<requirements_id>[0-9A-Fa-f-]{32,36})/practicerequire_edit/$',
            views.practice_require_edit,
            name='practice_require_edit'),

    re_path(r'^(?P<requirements_id>[0-9A-Fa-f-]{32,36})/requirements_delete/$',
